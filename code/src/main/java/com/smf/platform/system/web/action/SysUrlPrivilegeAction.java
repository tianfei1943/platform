 ...
 * 
 */
@Namespace("/platform/sysprivilege/urlprivilege")
@ParentPackage("smfjson-default")
@SuppressWarnings("serial")
public class SysUrlPrivilegeAction extends CrudActionSupport{
	 ...
	 */
	@Action(value = "list", results = { @Result(name = SUCCESS, location = "urlprivilege-json.jsp") })
	@SkipValidation
	public String list() throws Exception{
		SysPrivilege tempPrivilege = new SysPrivilege();
		tempPrivilege.setPrivilegeName(this.getPrivilegeName());
		PageResponse<SysPrivilege> pageresponse = sysPrivilegeService.list(tempPrivilege, SmfConst.PRIV_RESOURCE_TYPE_URL, page-1, rows);
	 ...
	 * @throws ParseException
	 */
	@Action(value = "listresource", results = { @Result(name = SUCCESS, location = "urlprivilege-resource-json.jsp") })
	@SkipValidation
	public String listUrlSysResource() throws Exception{
		List<SysResource> resource = sysResourceService.listSysresource(SmfConst.PRIV_RESOURCE_TYPE_URL);
		JsonConfig jsn = new JsonConfig();
	 ...
	 * @throws Exception
	 */
	@Action(value = "input", results = { @Result(name = INPUT, location = "urlprivilege-cu.jsp") })
	@SkipValidation
	...
	@Action(value = "save", results = {
			@Result(name = RELOAD, location = "urlprivilege.jsp", type = "redirect"),
			@Result(name = INPUT, location = "urlprivilege-cu.jsp") })
	public String save(){
		...
		privilege.setPrivilegeType(SmfConst.PRIV_RESOURCE_TYPE_URL);
	...
	public void setResourcesJson(String jsonResource) {
		this.resourcesJson = jsonResource;
	}
