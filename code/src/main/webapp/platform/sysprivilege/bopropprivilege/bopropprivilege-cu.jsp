...
<html>
	<head>
		<title>添加/修改业务对象属性权限</title>
		<script type="text/javascript" src="platform/sysprivilege/bopropprivilege/js/bopropprivilege-resource.js"></script>
	</head>
			...
			<div id="_title" class="content_title">
                <div id="_title_label" class="title_label">
                    <s:if test="id == null || id.isEmpty()">
    					<span>业务对象属性权限管理 - 添加业务对象属性权限</span>
					</s:if>
					<s:else>
						<span>业务对象属性权限管理 - 修改业务对象属性权限</span>
					</s:else>									
                </div>
            </div>
			...
			<table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr style="width: 100%"><td>
					<div style="margin:10px 0px 10px 10px">
						...
						<input type="button" value="&nbsp;返&nbsp;回&nbsp;" onClick="window.location.href = '<%=request.getContextPath()%>/platform/sysprivilege/bopropprivilege/bopropprivilege.jsp'" class="SUBMIT_BUTTON_CLASS"/>
					</div>
				</td></tr>
			</table>
		</form>
