...
<html>
	<head>
		<title>业务对象属性权限管理</title>
		<script type="text/javascript" src="platform/sysprivilege/bopropprivilege/js/bopropprivilege.js"></script>
	</head>	
	  ...
	  <div id="wrapper">
		<form id="privilegeForm" name="privilegeForm" method="post"">
			...
			<div id="_title" class="content_title">
                <div id="_title_label" class="title_label"><span>业务对象属性权限管理</span></div>
                <div id="_title_operation" class="title_operation">
                    <img src="<%=request.getContextPath()%>/images/icon_add.png" alt="添加" onClick="window.location.href='<%=request.getContextPath()%>/platform/sysprivilege/bopropprivilege/input.action'" >
