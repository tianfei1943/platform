$(function(){
			$('#urlprivilegeGrid').datagrid({
				...
				nowrap: true,
				striped: true,
				url:'platform/sysprivilege/boprivilege/listboresource.action',
				...
				columns:[[
	    			{title:'资源名称',field:'resourceName', width: 100, sortable: true},
					{title:'资源类型',field:'resourceType', width: 100, formatter : function(value){
						if(value == "url"){
							return "URL";
						}
					}},
					{title:'资源路径',field:'resourceUrl', width: 100, formatter : function(value) {
						if (value == null) {
							return "";
						}
						return value;
					}},
					{title:'资源描述',field:'desciption', width: 100, formatter : function(value) {
						if (value == null) {
							return "";
						}
						return value;
...
$(window).resize(function() {
			$('#urlprivilegeGrid').datagrid('resize', {
...
function editInfoType() {
	...
	$("#privilegeForm").attr('action','platform/sysprivilege/boprivilege/save.action');
