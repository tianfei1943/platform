...
<html>
	<head>
		<title>添加/修改菜单权限</title>
		<script type="text/javascript" src="platform/sysprivilege/menuprivilege/js/menuprivilege-resource.js"></script>
	</head>
			...
			<div id="_title" class="content_title">
                <div id="_title_label" class="title_label">
                    <s:if test="id == null || id.isEmpty()">
    					<span>菜单权限管理 - 添加菜单权限</span>
					</s:if>
					<s:else>
						<span>菜单权限管理 - 修改菜单权限</span>
					</s:else>									
                </div>
            </div>

			<table height="1px" style="width: 100%;" border="0" cellpadding="0"
				cellspacing="0">
				<tr>
			...
			<table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr style="width: 100%"><td>
					<div style="margin:10px 0px 0px 10px">
						...
						<div style="float:left; width:400px;  height:500px; overflow-y:scroll; border:1px solid;">
				...
				<tr style="width: 100%"><td>
					<div style="margin:10px 0px 10px 10px">
						...
						<input type="button" value="&nbsp;返&nbsp;回&nbsp;" onClick="window.location.href = '<%=request.getContextPath()%>/platform/sysprivilege/menuprivilege/menuprivilege.jsp'"
