...
<html>
	<head>
		<title>菜单权限管理</title>
		<script type="text/javascript" src="platform/sysprivilege/menuprivilege/js/menuprivilege.js"></script>
	</head>
	  ...
	  <div id="wrapper">
		<form id="privilegeForm" name="privilegeForm" method="post"">
			...
			<div id="_title" class="content_title">
                <div id="_title_label" class="title_label"><span>菜单权限管理</span></div>
                <div id="_title_operation" class="title_operation">
                    <img src="<%=request.getContextPath()%>/images/icon_add.png" alt="添加" onClick="window.location.href='<%=request.getContextPath()%>/platform/sysprivilege/menuprivilege/input.action'" >
